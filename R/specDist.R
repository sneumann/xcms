...
setGeneric("specDist.cosinus", function(peakTable1, peakTable2,
                                        mzabs = 0.001, mzppm = 10,
                                        mzExp = 0.6, intExp = 3,
                                        nPdiff = 2, nPmin = 8,
                                        symmetric = FALSE)
           standardGeneric("specDist.cosinus"))
setMethod("specDist.cosinus", signature(peakTable1="matrix", peakTable2="matrix"), function(peakTable1, peakTable2, mzabs = 0.001, mzppm = 10,
                                        mzExp = 0.6, intExp = 3,
                                        nPdiff = 2, nPmin = 8,
                                        symmetric = FALSE){
...
setGeneric("specDist.peakCount", function(peakTable1, peakTable2, mzabs=0.001, mzppm=10,symmetric=FALSE) standardGeneric("specDist.peakCount"))
