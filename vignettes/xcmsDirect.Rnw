...
<<Calibrate, results = hide, fig = TRUE, eps = FALSE, width = 5, height = 4>>=
xs4c <- calibrate(xs4,
		calibrants=masslist,
		method="edgeshift",
		mzabs=0.0001,
