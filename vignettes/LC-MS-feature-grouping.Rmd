...
vignette: >
  ...
  %\VignetteDepends{xcms,MsDataHub,BiocStyle,faahKO,pheatmap,MsFeatures}
...
```{r abundance-correlation-heatmap, fig.cap = "Heatmap representing pairwise correlation of features based on abundances across samples. Features are grouped on rows and columns."}
library(pheatmap)
