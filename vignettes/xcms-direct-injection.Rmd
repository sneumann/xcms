...
vignette: >
  ...
  %\VignetteDepends{xcms,MsDataHub,MassSpecWavelet,BiocStyle,signal,MSnbase}
---
...
In this documentation we use an example data set from the `r
Biocpkg("MsDataHub")` package. Assuming that `r Biocpkg("MsDataHub")` is
installed, we locate the path of the package and load the data set. We create
also a `data.frame` describing the experimental setup based on the file names.

```{r load-data, message = FALSE, results = "hide", warning = FALSE}
## Define the input files
mzML_files <- c(MsDataHub::HAM004_641fE_14.11.07..Exp1.extracted.mzML(),
