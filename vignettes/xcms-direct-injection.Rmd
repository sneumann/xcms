...
In this documentation we use an example data set from the `r Biocpkg("MsDataHub")`
package. Assuming that `r Biocpkg("MsDataHub")` is installed, it will obtain the files from https://doi.org/10.5281/zenodo.18494293 and load the data set. We create also a `data.frame` describing the
