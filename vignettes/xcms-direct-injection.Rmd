...
vignette: >
  ...
  %\VignetteDepends{xcms,msdata,MassSpecWavelet}
---
...
Below we load the required packages and set the parallel processing up
...
## Load the data.
ham_raw <- readMSData2(files = mzdata_files,
