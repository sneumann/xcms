...
vignette: >
  ...
  %\VignetteDepends{xcms,msdata,BiocStyle,magrittr,pander}
...
be extracted with the `chromPeakSpectra` method which returns a `MSpectra` object
...
The metadata column `"peak_id"` contains the identifiers of the chromatographic
...
spectrum using the `combineSpectra` method employing the `consensusSpectrum`
...
Flumanezil and Fenamiphos (from a collision energy of 20V).
