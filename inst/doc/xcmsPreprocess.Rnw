...
centroid LC/TOF-MS data. If your machine software or converter does 
not support the export of peak centroids, tools like the \emph{TOPP-PeakPicker} 
can be used for preprocessing \footnote{\url{http://www.openms.de}}. 
